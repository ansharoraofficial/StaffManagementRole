...
public class ModuleController {
	...
	public void addModule(@PathVariable Long roleId, @Valid @RequestBody CreateModelRequest module) {
		moduleService.addModule(roleId, module.getModule());
	}

	@GetMapping(value = "/module/{roleId}")
	public List<ModuleDTO> getModules(@PathVariable Long roleId) {
	...
	@PutMapping(value = "module/{module_id}")
	public void updateModule(@PathVariable("module_id") Long moduleId, @Valid @RequestBody UpdatedModule module) {
